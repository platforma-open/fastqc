...
export type FastqcBlockContract = BlockContract;
export type FastqcBlockOutputs  = BlockOutputs;
export type FastqcBlockData     = BlockData;
export const FastqcBlockPointer = BlockPointer;
